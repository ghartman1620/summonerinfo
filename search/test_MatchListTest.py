...
class SmallMatchListTest(TestCase):
    ...
    def testTowersKilledInLosses(self):         
        ...
        self.assertEqual(result[('OUTER_TURRET', 'TOP_LANE')][0],33.333333333333336)
        self.assertEqual(result[('OUTER_TURRET', 'MID_LANE')][1].seconds,1241)
        self.assertEqual(result[('OUTER_TURRET', 'MID_LANE')][0],33.333333333333336)
        self.assertEqual(result[('OUTER_TURRET', 'BOT_LANE')][1].seconds,1282)
        self.assertEqual(result[('OUTER_TURRET', 'BOT_LANE')][0],33.333333333333336)
        self.assertEqual(result[('INNER_TURRET', 'BOT_LANE')][1].seconds,1306)
        self.assertEqual(result[('INNER_TURRET', 'BOT_LANE')][0],33.333333333333336)
    ...
    def testTowersLostInLosses(self):
        ...
        self.assertEqual(result[('BASE_TURRET', 'TOP_LANE')][0],66.66666666666667)
        self.assertEqual(result[('NEXUS_TURRET', 'MID_LANE')][1].seconds,1311)
        self.assertEqual(result[('NEXUS_TURRET', 'MID_LANE')][0],66.66666666666667)
        self.assertEqual(result[('BASE_TURRET', 'BOT_LANE')][1].seconds,1259)
        self.assertEqual(result[('BASE_TURRET', 'BOT_LANE')][0],66.66666666666667)
